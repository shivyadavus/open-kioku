class OpenKioku < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.3.0/ok-macos-arm64"
      sha256 "85922cbad9f623ff8f6f85fba4c0670e6ab9fb0b6d3b46e612d96232a2e8c82d"
    else
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.3.0/ok-macos-x86_64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.3.0/ok-linux-arm64"
      sha256 "35868a85311749b8d4e9ccf6b1e721383094a037c1a98fd93ece18b6aa63e1b7"
    else
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.3.0/ok-linux-x86_64"
