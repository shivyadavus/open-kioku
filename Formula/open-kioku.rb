class OpenKioku < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.2.0/ok-macos-arm64"
      sha256 "2db7ab0b77293988349b27da72cbdde2f37ddf5d897ef13ec3020cadc3fb90e0"
    else
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.2.0/ok-macos-x86_64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.2.0/ok-linux-arm64"
      sha256 "1a88a5031ef0c66a704c2c7f5469c0ed5f1a808da2baea305083e3237b9619b3"
    else
      url "https://github.com/shivyadavus/open-kioku/releases/download/v2.2.0/ok-linux-x86_64"
