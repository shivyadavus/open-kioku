...
The workspace is composed of 41 focused crates (e.g., `open-kioku-core`, `open-kioku-storage-sqlite`, `open-kioku-mcp`). When adding a new feature, place it in the most specific crate or create a new crate if it represents a distinct architectural component.
