...
|---|---|---|---|---|---|---|
| gte-modernbert-base | go-a (Go, 193 cases) | 0.389 → 0.409 | 0.534 → 0.549 | 0.284 → 0.309 | 4.4 GB | 25 min |
| gte-modernbert-base | ts-a (TS, 193 cases) | 0.565 → 0.580 | 0.632 → 0.668 | 0.453 → 0.479 | 4.5 GB | 35 min |
| jina-v2-code | go-a | 0.389 → 0.399 | 0.534 → 0.534 | 0.284 → 0.291 | 14.7 GB† | 61 min |
| jina-v2-code | ts-a | 0.565 → 0.565 | 0.632 → 0.632 | 0.450 → 0.455 | 12.7 GB† | 95 min |
| Qwen3-0.6B (candle, CPU) | go-a, ts-a | — | — | — | — | >3 h, job timed out |
