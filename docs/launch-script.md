...
For launch proof, `ok prove` generates a shareable report with task scores and redacted path shapes, without source snippets. The public-repository audit tests Open Kioku 2.1.0 across several permissively licensed repositories. One representative run indexed 4,623 files, 46,738 symbols, 49,459 chunks, 8,945 tests, and 79,426 graph edges locally in 33.1 seconds.
