...
`git revert` of the change under test. Corpus: a fixed subtree (1,751 Java files)
of a 10k-file Java service at a fixed commit. Fresh `.ok` per run, arms alternated across three rounds.
