...
- **Must not emit:**
  ...
  - `crate::` reaching another workspace member's same-text module, a module only the root package of a workspace declares, or, from a `src/bin/` crate root, the library's module;
