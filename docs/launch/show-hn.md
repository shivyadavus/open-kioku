...
```text
I built Open Kioku, local code intelligence for AI coding agents.
...
- context packs
- language-specific static facts and optional runtime evidence
...
I also wanted proof on a non-toy repo. On a local Elasticsearch run it indexed 36,640 files, 495,919 symbols, 509,665 chunks, 159,483 tests, 36,363 static analysis facts, and 1,015,502 graph edges. The proof notes are in docs/large-repo-proof.md.
