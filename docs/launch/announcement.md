...
On a local java-a validation run, Open Kioku indexed 36,640 files, 495,919 symbols, 509,665 chunks, 159,483 tests, 36,363 static analysis facts, and 1,015,502 graph edges. The proof notes are in `docs/large-repo-proof.md`.
