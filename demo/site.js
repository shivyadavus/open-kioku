const steps={
plan:{title:'ok plan · representative output',html:`<div><span class="prompt">$</span> ok --json plan "change token expiration"</div><br><div class="good">✓ 5 primary context items</div><div class="good">✓ 3 direct impact candidates</div><div class="good">✓ 2 validation candidates</div><div class="result-title">risk: <span class="warn">medium · 0.26</span></div><div><span class="json-key">primary:</span> <span class="json-string">src/auth.rs</span>, <span class="json-string">src/lib.rs</span>, <span class="json-string">ok.toml</span>, <span class="json-string">tests/auth_flow.rs</span>, <span class="json-string">README.md</span></div><br><div class="warn">! exact references, runtime, history, and coverage were unavailable</div><div class="comment"># Missing evidence lowers confidence instead of inventing certainty.</div>`},
impact:{title:'impact · from the real plan',html:`<div><span class="prompt">$</span> plan.impact.direct_impacts</div><br><div class="result-title">3 direct impact candidates</div><div><span class="json-string">src/lib.rs:7-12</span> <span class="comment"># handle_login · also lines 1-2, 3-6</span></div><div><span class="json-string">tests/auth_flow.rs:4-7</span> <span class="comment"># login_returns_valid_token</span></div><div><span class="json-string">ok.toml:81-147</span> <span class="comment"># lexical match</span></div><br><div class="warn">! evidence quality caveat: exact symbol/reference evidence unavailable</div>`},
tests:{title:'validation · from the real plan',html:`<div><span class="prompt">$</span> plan.validation</div><br><div class="result-title">2 runnable candidates · command: <span class="json-string">cargo test</span></div><div><span class="good">01</span> login_returns_valid_token</div><div><span class="good">02</span> issues_token_with_user_id</div><br><div class="comment"># Selected before the source edit from indexed repository evidence.</div>`},
